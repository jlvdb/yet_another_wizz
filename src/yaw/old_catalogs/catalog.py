...
class BaseCatalog:
    ...
    def __init__(
        ...
        *,
        ...
        :meth:`yaw.old_catalogs.NewCatalog.from_dataframe`."""
        pass
    ...
    def from_file(
        ...
        **kwargs,
        ...
        Catalogs should be instantiated through the factory class, see
        :meth:`yaw.old_catalogs.NewCatalog.from_file`."""
    ...
    def from_cache(cls, cache_directory: str, progress: bool = False) -> BaseCatalog:
        ...
        Catalogs should be instantiated through the factory class, see
        :meth:`yaw.old_catalogs.NewCatalog.from_cache`."""
    ...
    def load(self) -> None:
        ...
        Raises a :obj:`~yaw.old_catalogs.scipy.patches.CachingError` if no cache
        is configured.
        """
    ...
    def correlate(
        ...
        Args:
            ...
            linkage (:obj:`~yaw.old_catalogs.linkage.PatchLinkage`, optional):
