...
def get_patch_list(
    ...
    Args:
        catalog1 (:obj:`yaw.old_catalogs.scipy.ScipyCatalog`):
            The first input data catalogue.
        catalog2 (:obj:`yaw.old_catalogs.scipy.ScipyCatalog`, :obj:`None`):
        ...
        linkage (:obj:`~yaw.old_catalogs.linkage.PatchLinkage`, :obj:`None`):
...
def count_pairs_patches(
    ...
    Args:
        patch1 (:obj:`yaw.old_catalogs.scipy.PatchCatalog`):
            The first input patch catalogue.
        patch2 (:obj:`yaw.old_catalogs.scipy.PatchCatalog`):
...
def count_histogram_patch(
    ...
    Args:
        patch (:obj:`yaw.old_catalogs.scipy.PatchCatalog`):
